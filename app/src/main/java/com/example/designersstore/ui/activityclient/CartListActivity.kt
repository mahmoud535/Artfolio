...
import com.example.designersstore.ui.adapters.CartItemsListAdapter
...
class CartListActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_checkout.setOnClickListener {
            val intent= Intent(this@CartListActivity,AddressListActivity_Client::class.java)
    ...
    fun successCartItemsList(cartList: ArrayList<CartItem>) {
        ...
        if (mCartListItems.size > 0) {
            ...
            tv_sub_total.text = "ج.م$subTotal"
            // Here we have kept Shipping Charge is fixed as $10 but in your case it may cary. Also, it depends on the location and total amount.
            tv_shipping_charge.text = "ج.م10.0"

            if (subTotal > 0) {
                ll_checkout.visibility = View.VISIBLE

                val total = subTotal + 10
                tv_total_amount.text = "ج.م$total"
            } else {
