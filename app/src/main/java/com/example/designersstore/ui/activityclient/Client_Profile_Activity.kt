...
class Client_Profile_Activity : BaseActivity(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_client__profile_)
        ...
        if (mUserDetails.profileCompleted==0){
            ...
            GlideLoader(this@Client_Profile_Activity).loadUserPicture(mUserDetails.image,iv_user_photo)
        ...
        iv_user_photo.setOnClickListener(this@Client_Profile_Activity)
        btn_submit.setOnClickListener(this@Client_Profile_Activity)
    }
